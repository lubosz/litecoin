...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/elysium-project/elysium>";
    const std::string URL_WEBSITE = "<https://elysium.org>";
