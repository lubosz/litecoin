...
uint256 hashGenesisBlock("0xd24b59252d11d8d27c52d3365e42341e341a59b9ae33847dbff2bd87510b5341");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(493092763); // Elysium: starting difficulty is 1 / 2^12
...
{
    int64 nSubsidy = 55000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 640000); // Elysium: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Elysium: 3.5 days
static const int64 nTargetSpacing = 120; // Elysium: 2.5 minutes
...
{
    // Elysium: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x61637b9460028af2b327f78679cb86ec0a1fabd1c1c36859b163a79054b7cac2");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].nValue = 55000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("a3821465ef3c4be973f9b42b7fb39a861cc251aea0fc775bc08c6386b01762702f92c5acf09588545490de34691c198037bae3ac63a81679b5773e46b451e65152") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1488669347;
        block.nBits    = 493092763;
        block.nNonce   = 1796819953;

        if (fTestNet)
        {
            block.nTime    = 1488669347;
            block.nNonce   = 2967378972;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3a2bb50cfa5ca6357a9fa46271c917edf80b6f6f2b6846196add6751aaf03378"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Elysium: increase each by adding 2 to bitcoin's value.
