...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s elysium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  elysium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded elysium transaction") + "\n" +
              "  elysium-tx [options] -create [commands]   " + _("Create hex-encoded elysium transaction") + "\n" +
              "\n";
