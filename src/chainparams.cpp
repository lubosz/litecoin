...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.elysium.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("elysiumtools.com", "dnsseed.elysiumtools.com"));
        vSeeds.push_back(CDNSSeedData("elysiumpool.org", "dnsseed.elysiumpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("elysiumtools.com", "testnet-seed.elysiumtools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.elysium.loshan.co.uk", true));
