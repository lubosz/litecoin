...
VERSION=
commit=false
url=https://github.com/elysium-project/elysium
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/elysium-project/elysium
...
then
	# Make output folder
	mkdir -p ./elysium-binaries/${VERSION}
